...
extern SEXP cop_allreduce_spmat_add(SEXP send_data_s4, SEXP root, SEXP R_comm, SEXP scalar_type_);

static const R_CallMethodDef CallEntries[] = {
  {"cop_allreduce_mat_userop", (DL_FUNC) &cop_allreduce_mat_userop, 6},
  {"cop_allreduce_mat_qr", (DL_FUNC) &cop_allreduce_mat_qr, 4},
  {"cop_allreduce_spmat_add", (DL_FUNC) &cop_allreduce_spmat_add, 4},
  {NULL, NULL, 0}
};
